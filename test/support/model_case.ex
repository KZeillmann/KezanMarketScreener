defmodule KezanMarketScreener.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import KezanMarketScreener.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&KezanMarketScreener.ErrorHelpers.translate_error/1)
